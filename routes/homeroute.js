...
import Dashboard from '../src/screens/home/components/dashboard';
import HomeDashboard from '../src/screens/home/components/Dashboard/HomeDashboard';
...
export default function Appli() {
  ...
  return (
    <NavigationContainer>
      <Stk.Navigator>
        {loading ? (
          <Stk.Screen name="Loadong" component={Loading} />
        ) : usr ? (
          <Stk.Screen
            name="Home"
        ...
        <Stk.Screen name="Logintest" component={AuthScreen} />
        <Stk.Screen name="Hometest" component={Home} />
