    ...
    <View>
      ...
      <View style={style.container}>
        <View style={[style.row]}>
          <Text style={style.haeading}>Name</Text>
          <Text style={style.value}>{name}</Text>
        </View>
        <View style={[style.row]}>
          <Text style={style.haeading}>Beneficiary Id</Text>
          <Text style={style.value}>{id}</Text>
        </View>
        <View style={[style.row, {paddingBottom: 20}]}>
          <Text style={style.haeading}>Date of 1st dose</Text>
...
const style = StyleSheet.create({
  ...
  txt: {fontSize: 20, fontWeight: '700', marginVertical: 15},
});
