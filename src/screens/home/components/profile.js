...
export default function Profile({navigation}) {
  ...
  const [homenav, setHome] = useState(false);
      ...
      <View style={{marginVertical: 10}}>
        ...
        <View style={{marginHorizontal: 30}}>
          <TextInput
            ...
            value={name}
            left={<TextInput.Icon name="account" color="#ff9551" />}
          ...
          <TextInput
            ...
            value={id}
            left={<TextInput.Icon name="key" color="#ff9551" />}
            type="flat"
            selectionColor={Colors.white}
            ...
            style={[
              globalStyles.txt,
              globalStyles.round,
              {marginVertical: 10, textAlign: 'left', borderRadius: 20},
            ]}
          ...
          <View
            ...
            <TextInput
              ...
              placeholder="Select your 1st dose"
              style={[globalStyles.txt, globalStyles.round, {width: 250}]}
              label="1st dose date"
            />
          ...
          <Button
            ...
            mode="contained"
            style={[globalStyles.btn, {backgroundColor: '#ff9551'}]}>
            SetDetails
          </Button>
        </View>
      </View>
