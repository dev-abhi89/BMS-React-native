    ...
    <View style={{backgroundColor: '#f7f1e5', flex: 1}}>
      ...
      <View>
        <View style={{marginHorizontal: 30, marginVertical: 20}}>
          <TextInput
            theme={{colors: {primary: '#ff9551'}}}
            value={email}
            onChangeText={val => setEmail(val)}
            left={<TextInput.Icon name="email" color="#ff9551" />}
            type="flat"
            label="Email"
            onChange={() => setEmail}
            underlineColor="transparent"
            style={[style.input, style.round]}
          ...
          <TextInput
            ...
            left={<TextInput.Icon name="lock" color="#ff9551" />}
            type="flat"
            onChange={() => setPass}
            label="password"
            underlineColor="transparent"
          ...
          <Text
            ...
            {screen ? 'Create a user account' : 'Switch to login page'}
          </Text>
        </View>
      </View>
      {/* <View style={{overflow: 'hidden'}}>
        <Image
          style={style.img}
          source={require('../assets/images/three_doc.png')}
        />
      </View> */}
    </View>
  );
